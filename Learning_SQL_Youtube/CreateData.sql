...
CREATE TABLE sinhVien(
    ...
    ngaySinh DATE,
    namNhapHoc DATE,
    maChuongTrinhDaoTao NVARCHAR(50),
    gioiTinh TINYINT,
    PRIMARY KEY (maSinhVien),
    CONSTRAINT FK_sinhVien_chuongTrinhDaoTao FOREIGN KEY (maChuongTrinhDaoTao) REFERENCES chuongTrinhDaoTao(maChuongTrinh)
);
...
CREATE TABLE chuongTrinhDaoTao(
	maChuongTrinhDaoTao NVARCHAR(50) NOT NULL UNIQUE,
    tenChuongTrinhDaoTao NVARCHAR(200),
    soTinChi FLOAT,
    namBatDauDaoTao DATE,
...
CREATE TABLE monHoc(
  ...
  `maChuongTrinhDaoTao` varchar(50) ,
...
CREATE TABLE thamGiaHoc(
    ...
    CONSTRAINT FK_thamGiaHoc_sinhVien FOREIGN KEY(maSinhVien) REFERENCES sinhSien(maSinhVien)
);
